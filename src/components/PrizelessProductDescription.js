...
function PrizelessProductDescription({ onCloseClick }) {
  return (
    <>
       <div className='product-description-overlay'>
         <div className='product-desc-container'>
         <button type="" 
         className='product-desc-container-close' onClick={onCloseClick} 
...
export default PrizelessProductDescription
